...
import models.conexion.ConexionModelo;
import models.crud.UsuarioCrud;
...
//        }
    ...
    //metodo para procesar las acciones que llegan desde la vista hasta el server
    ...
    public void guardarUsuario(HttpServletRequest request, HttpServletResponse response){
        ...
        //UsuarioCrud crudUser = new UsuarioCrud(conexion.getFabricaConexion());
        //crudUser.agregar(u1);
        try {
            response.sendRedirect("usuarios/agregar.jsp?mensaje=Usuario agr");
